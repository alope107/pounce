...
static constexpr fish_info FISH_TABLE[4] = {
    fish_info{bn::sprite_items::snack, bn::sprite_items::deadsnack, 5},
    fish_info{bn::sprite_items::salmon, bn::sprite_items::deadsalmon, 5},
    fish_info{bn::sprite_items::puffer, bn::sprite_items::deadpuffer, 5},
    fish_info{bn::sprite_items::realgoldfish, bn::sprite_items::deadgoldfish, 5},
};
